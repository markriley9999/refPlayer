...
ffmpeg -y -f concat -i cat-v5.txt -c copy -t 3600 tmp\av5.mp4 
...
MP4Box -dash 3840 -segment-timeline -url-template -rap -frag-rap -bs-switching inband -profile dashavc264:live -segment-name $RepresentationID$/SEG$Number$ -out tmp\DASH.mpd tmp\v1.mp4 tmp\v2.mp4 tmp\v3.mp4 tmp\v4.mp4 tmp\av5.mp4#video tmp\av5.mp4#audio
