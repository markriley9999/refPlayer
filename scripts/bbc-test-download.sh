...
./cdndownload.sh \""$UA"\" $BASEURL "avc3-events/704x396p50/IS.mp4" 	"IS.mp4" "avc3-events/704x396p50/" 		"test/avc3-events/704x396p50/" 		"" 1 $SEGS $PAD $COOKIE
...
./cdndownload.sh \""$UA"\" $BASEURL "avc3-events/512x288p25/IS.mp4" 	"IS.mp4" "avc3-events/512x288p25/" 		"test/avc3-events/512x288p25/" 		"" 1 $SEGS $PAD $COOKIE
...
./cdndownload.sh \""$UA"\" $BASEURL "avc3-events/704x396p25/IS.mp4" 	"IS.mp4" "avc3-events/704x396p25/" 		"test/avc3-events/704x396p25/" 	"" 1 $SEGS $PAD $COOKIE

./cdndownload.sh \""$UA"\" $BASEURL "audio/320kbps-5_1/IS.mp4" 	"IS.mp4" "audio/320kbps-5_1/" 	"test/audio/320kbps-5_1/" 	"" 1 $SEGS $PAD $COOKIE
./cdndownload.sh \""$UA"\" $BASEURL "audio/128kbps/IS.mp4" 		"IS.mp4" "audio/128kbps/" 		"test/audio/128kbps/" 		"" 1 $SEGS $PAD $COOKIE
